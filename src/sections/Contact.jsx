...
Send me a message and let’s turn your ideas into real, working solutions.
          </p>
        </div>
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                Whether you need a full-time computer engineer or a freelance consultant,
                let's talk!
              </p>
            </div>
          </div>
